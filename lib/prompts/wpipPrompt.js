...
module.exports = async (generator, basmApi) => {
  ...
  switch (scenario) {
    case ScenariosEnum.FROM_COURT: return fromCourt(generator);
    case ScenariosEnum.NO_IDENTIFIERS: return generator.fromCourt();
    case ScenariosEnum.PNC_ONLY_UNMATCHED: return generator.fromCourtWithUnmatchedPnc();
    case ScenariosEnum.COURT_RETURN: return generator.courtReturn();
    case ScenariosEnum.FROM_CUSTODY_SUITE: return generator.fromPoliceCustodySuite();
    case ScenariosEnum.SINGLE_MATCH: return generator.singleMatch();
    case ScenariosEnum.MANUAL_MULTIPLE_MATCH: return generator.manualMultipleMatch();
    case ScenariosEnum.AUTOMATIC_MULTIPLE_MATCH: return generator.automaticMultipleMatch();
    case ScenariosEnum.PRINT_REFERENCE_DATA: return printReferenceData(logger.console, basmApi);
    default: throw Error('Data not generated or printed');
  }
};
