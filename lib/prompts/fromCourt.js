...
module.exports = async generator => {
  const prompt = new Form({
    ...
    choices: [
      ...
      { name: 'firstName', message: 'First Name', initial: faker.person.firstName() },
      { name: 'lastName', message: 'Last Name', initial: faker.person.lastName() },
      {
        name: 'dob',
        message: 'Date of birth',
        initial: format(faker.date.between({ from: '1980-01-01T01:01:01.000Z', to: '2004-01-01T01:01:01.000Z' }), 'yyyy-MM-dd'),
      },
